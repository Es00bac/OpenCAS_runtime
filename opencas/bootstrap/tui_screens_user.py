...
class VibesScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(2, 17, "Professional Partnership Profile")
        yield HelpText(
...
class IdentityScreen(Screen):
    def compose(self) -> ComposeResult:
        yield StepHeader(3, 17, "Names & Introductions")
        yield HelpText(
...
class ThemeScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(4, 17, "Persona Theme")
        yield HelpText(
...
class VisionScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(5, 17, "Partnership Vision")
        yield HelpText(
...
class AboutMeScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(6, 17, "About You")
        yield HelpText(
...
class LearningStyleScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(7, 17, "How You Learn & Collaborate")
        yield HelpText(
...
class EmotionsScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(8, 17, "Emotional Landscape & Triggers")
        yield HelpText(
...
class GoalsScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield StepHeader(9, 17, "Initial Goals & Commitments")
        yield HelpText(
