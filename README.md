...
This public repository is a sanitized release snapshot. It is meant to document and share the current runtime shape without including private state, credentials, or live operator data.
...
| Document | Purpose |
| --- | --- |
| [Installation Guide](docs/release/installation.md) | Setup steps for the current repository layout |
| [Usage Guide](docs/release/usage.md) | Running OpenCAS and using its dashboard/API surfaces |
| [Features](docs/release/features.md) | Current subsystem and capability summary |
| [Terminology](docs/release/terminology.md) | Vocabulary used by the docs, dashboard, and code |
| [API Reference](docs/release/api/README.md) | HTTP and WebSocket surfaces exposed by the server |
| [Architecture](docs/release/architecture/README.md) | Runtime structure, loops, persistence, and subsystem boundaries |
| [Changelog](docs/release/CHANGELOG.md) | Release notes for this public snapshot |
| [Website Source](docs/release/website/index.html) | Static documentation site included with the release |
...
OpenCAS is released under AGPL-3.0-or-later. See [LICENSE](LICENSE).
